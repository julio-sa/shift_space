...
class CTypesBackend(object):
    ...
    def complete_struct_or_union(self, CTypesStructOrUnion, fields, tp,
        ...
        if totalsize >= 0 or totalalignment >= 0:
            raise NotImplementedError("the ctypes api of CFFI does not support "
    ...
    def new_function_type(self, BArgs, BResult, has_varargs):
        ...
        class CTypesFunctionPtr(CTypesGenericPtr):
            ...
            def _initialize(ctypes_ptr, value):
                if value:
                    raise NotImplementedError("ctypes api: not supported: "
    ...
    def buffer(self, bptr, size=-1):
        raise NotImplementedError("buffer() with ctypes api")
