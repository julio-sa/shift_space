...
class BackendUnavailable(Exception):
    ...
    def __init__(
        ...
        super().__init__(message or "Error while importing api")
...
class BuildBackendHookCaller:
    """A wrapper to call the build api hooks for a source directory."""
    ...
    def __init__(
        ...
        """
        :param source_dir: The source directory to invoke the build api for
        :param build_backend: The build api spec
        :param backend_path: Additional path entries for the build api spec
        :param runner: The :ref:`subprocess runner <Subprocess Runners>` to use
        :param python_executable:
            The Python executable used to invoke the build api
        """
        if runner is None:
    ...
    def _supported_features(self) -> Sequence[str]:
        """Return the list of optional features supported by the api."""
    ...
    def get_requires_for_build_wheel(
        ...
        :param config_settings: The configuration settings for the build api
        :returns: A list of :pep:`dependency specifiers <508>`.

        .. admonition:: Fallback

            If the build api does not defined a hook with this name, an
    ...
    def prepare_metadata_for_build_wheel(
        ...
        .. admonition:: Fallback
            ...
            If the build api does not define a hook with this name and
            ``_allow_fallback`` is truthy, the api will be asked to build a
    ...
    def build_wheel(
        ...
        .. admonition:: Interaction with fallback
            ...
            :meth:`prepare_metadata_for_build_wheel`, the build api would
    ...
    def build_editable(
        ...
        .. admonition:: Interaction with fallback
            ...
            :meth:`prepare_metadata_for_build_editable`, the build api
